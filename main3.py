    ...
    def eval(self, epoch, save_score=False, loader_name=['test']):
        ...
        for ln in loader_name:
            ...
            for batch_idx, (data, label) in enumerate(self.data_loader[ln]):
                #print('\n----------------dataloader1: ', self.data_loader[ln].dataset.data_path)
                #print('\n----------------data+label: ',batch_idx, (data,label))
                data = Variable(
                ...
                output = self.model(data)
                # JIN's code
                max_score = torch.max(output.data, 1) # max_score[0] = max value; max_score[1] = max_index
                #print('-------Output Data-------\n', output.data, '\n')
                #print('-------Output Max -------\n', max_score[0],'\n')
                print('\n----------------\nResult: ', max_score[1]) #Output Max Index
                print('Label: ', label)
